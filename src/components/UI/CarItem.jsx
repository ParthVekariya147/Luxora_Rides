...
const CarItem = (props) => {
    ...
    const { image_url, year_model, car_name, technical_specifications, price_per_day, _id } = props.item || {};
    ...
    return <Col lg='4' md='4' sm='6' className='mb-5'>
            <div className="car__item">
                <div className="car__img">
                    <img src={image_url} alt={car_name || "Car"} className='w-100' onError={(e) => { e.target.src = 'https://placehold.co/600x400?text=Car+Image'; }} />
                </div>

                <div className="car__item-content mt-4">
                        <h4 className="section__title text-center"> {car_name || "Unknown Car"} </h4>
                        <h6 className="rent__price text-center mt-2"> ₹{price_per_day || 0}.00 <span>/ Day</span> </h6>
