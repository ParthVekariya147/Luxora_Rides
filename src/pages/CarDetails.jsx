...
const CarDetails = () => {
  ...
  return (
    <Helmet title={singleCarItem.car_name}>
      <section>
        <Container>
          <Row>
            <Col lg="6">
              <img
                src={singleCarItem.image_url}
                alt={singleCarItem.car_name}
                className="w-100"
              />
            </Col>
              ...
              <div className="car__info">
                ...
                <div className="d-flex align-items-center gap-5 mb-4 mt-3">
                  ...
                  <span className="d-flex align-items-center gap-2">
                    ...
                    ({singleCarItem.ratings || singleCarItem.average_rating}{" "}
                    ratings)
                  </span>
                </div>
                  ...
                  <div className="rental-details mb-4 p-3 border rounded">
                    ...
                    <div className="d-flex flex-column gap-2">
                      <span>
                        ...
                        {singleCarItem.rental_details.security_deposit_inr}
                      </span>
                      <span>
                        <strong>Daily Kilometers Included:</strong>{" "}
                        {
                          singleCarItem.rental_details
                            .kilometers_included_per_day
                        }{" "}
                        km
                      </span>
                      <span>
                        ...
                        {
                          singleCarItem.rental_details
                            .extra_km_charge_per_unit_inr
                        }
                        /km
                      </span>
                      <span>
                        <strong>Insurance:</strong>{" "}
                        {singleCarItem.rental_details.insurance_included
                          ? "Included"
                          : "Not Included"}
                      </span>
                    </div>
